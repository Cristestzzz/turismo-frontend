...
} from "./chunk-32XETUBI.js";
import {
  useIsomorphicEffect_default
} from "./chunk-7JCRPGGX.js";
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-UC33Y6YE.js";
import {
  Container_default
} from "./chunk-BMRHODM6.js";
import {
  Button_default
} from "./chunk-URKTTIPO.js";
import "./chunk-WNXXD6FK.js";
import {
  ModalBody_default,
  ModalDialog_default,
  ModalFooter_default,
...
} from "./chunk-YW2CSSGD.js";
import {
  useEventCallback as useEventCallback2
} from "./chunk-POTD5FCB.js";
import {
  require_react_dom
...
var FormGroup = React45.forwardRef(({
  ...
  const context3 = (0, import_react15.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime69.jsxs)(import_jsx_runtime68.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react24.cloneElement)(children, triggerProps), (0, import_jsx_runtime67.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React66.forwardRef(({
  ...
  return (0, import_jsx_runtime72.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames56.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames57.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var ToastBody = React84.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React86.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop2 = () => void 0;
var ToggleButton = React87.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React88.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
